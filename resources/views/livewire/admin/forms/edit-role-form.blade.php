<div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                            wire:model.defer="name" placeholder="Enter role name">
                        ...
                        <div class="permission-section">
                            ...
                            <div class="d-flex flex-wrap gap-4 mb-3">
                                ...
                                <div class="form-check d-flex align-items-start gap-3 mb-2">
                                    <input class="form-check-input mt-0" type="checkbox" wire:model="permissions"
    ...
    <div class="activity-section">
        <h5 class="fw-bold mb-2 p-3">Associated Users</h5>
        <div class="logs-items">
            <ul class="logs-list list-unstyled px-3">
                @forelse ($users as $user)
                                    <li class="d-flex align-items-start gap-3 mb-2">
                    <img src="{{ $user->AvatarUrl }}" alt="" class="logs-item-image">
                    <div>
                        <h6 class="mb-1">{{ $user->f_name }} {{ $user->l_name }}</h6>
                        <p class="text-muted fs-12 mb-1">Email: {{ $user->email }}</p>
                    </div>
                </li>
                @empty
                    <li class="text-muted text-italic"><small><i>No associated users found.</i></small></li>
                @endforelse
