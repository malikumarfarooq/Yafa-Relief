        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                        wire:model.defer="title" placeholder="Enter story title">
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                        <span wire:loading.remove>Create Story</span>
            ...
            <div class="col-md-3">
                ...
                <div class="image-box my-1">
                    ...
                    <input type="file" wire:model="thumbnail" id="logoInput" class="hidden-input" style="display:none"
                        accept="image/png, image/jpeg, image/webp, image/jpg, image/gif">
                </div>
                <small class="text-muted">PNG, WEBP, GIF, JPEG and JPG - Max: 1024KB</small><br>
                ...
                <div class="image-box my-1">
                    ...
                    <label for="coverImage" class="edit-btn">
                        <i class="lni lni-brush-2"></i>
                    </label>
                    <input type="file" wire:model="cover_image" id="coverImage" class="hidden-input"
