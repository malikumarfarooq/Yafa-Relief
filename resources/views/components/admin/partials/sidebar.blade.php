        ...
        <div class="sidebar-profile dropdown w-100 mt-2">
            <div class="sidebar-profile-section d-flex justify-content-between align-items-center dropdown-toggle"
                ...
                <div class="profile-details-section d-flex align-items-center">
                    <img src="/admin-assets/images/user-avatar.jpg" alt="User Avatar" class="avatar-image me-2">
                    <div class="avatar-placeholder me-2 d-none">JD</div>
                    <div>
                        <div class="sidebar-profile-name">John Doe</div>
            ...
            <ul class="dropdown-menu profile-dropdown-menu mb-2 py-2">
                ...
                <li><a class="dropdown-item text-danger px-3 py-2 d-flex align-items-center line-hight-100" href="#">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
